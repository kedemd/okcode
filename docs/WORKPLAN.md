...
| C2 surfaces                                                                                                            | done (tools 15, CLI 9 + 1 todo: `reset --scope fts` waits on okdb fix #1)                                                     |
| okdb fixes from okcode (FTS nested txn, pipeline cleanup, cross-process rebuild, resolver-before-open, factory getter) | in progress                                                                                                                   |
| D integration                                                                                                          | —                                                                                                                             |
